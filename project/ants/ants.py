...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while temp_place != None and temp_place != beehive:
            if dist < self.min_range:
                ...
                return None
            elif temp_place.bees != []:
                return temp_place.bees[random.randint(0, len(temp_place.bees) - 1)]
            else:
                temp_place = temp_place.entrance
                dist = dist + 1
        # END Problem 3 and 4
...
class HungryAnt(Ant):
    ...
    def __init__(self, armor=1):
        # BEGIN Problem 6
        "*** YOUR CODE HERE ***"
        self.digesting = 0 # 添加instance attribute
        Ant.__init__(self, armor)
        # END Problem 6
    ...
    def action(self, gamestate):
        ...
        if self.digesting > 0:
            ...
            if self.place.bees != []:
                bee_eaten = self.place.bees[random.randint(0, len(self.place.bees) - 1)]
                self.eat_bee(bee_eaten)
...
class ScubaThrower(ThrowerAnt):
    ...
    food_cost = 6
    implemented = True
    is_watersafe = True # 一类的is_watersafe都是一样的，所以它是一个定义在类中的类属性，不是定义在__init__中的成员属性
# END Problem 9
...
# END Problem EC
    ...
    def reduce_armor(self, amount):
        ...
        if self.idx == 1 and self.armor == 0:
            bees_win()
        # END Problem EC
